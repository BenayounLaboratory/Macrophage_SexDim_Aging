...
# summarize_SexAge( my.m.react,
#                   my.f.react,
#                   "REACTOME")
summarize_SexAge_peak <- function(my.m.gset, my.f.gset, my.gset.name, my.thrs = 0.05){
  ...
  pdf(paste0(Sys.Date(), "_GSEA_enrichment_", my.gset.name, "_GSEA_enrichment_PeriMac_Sex_Aging_FDR5_scatterplot_H3K4me3_height.pdf"), width = 6, height = 6)
  ...
  write.table(my.merged.gset.both, file = paste0(Sys.Date(), "_GSEA_enrichment_", my.gset.name, "_GSEA_enrichment_PeriMac_Sex_Aging_FDR", 100* my.thrs, "_Summary_H3K4me3_height.txt"),
  ...
  pdf( paste(Sys.Date(),"GSEA_aging_BALLOON_plot",my.gset.name,"top_10_DIVERGENT_pathways_PeriMac_Sex_Aging_H3K4me3_height.pdf", sep="_"), onefile=T, height = 4, width=5)
  print(my.plot)
  dev.off()
  ...
  pdf( paste(Sys.Date(),"GSEA_aging_BALLOON_plot",my.gset.name,"top_10_CONVERGENT_pathways_PeriMac_Sex_Aging_H3K4me3_height.pdf", sep="_"), onefile=T, height = 4, width=5)
  print(my.plot)
  dev.off()
