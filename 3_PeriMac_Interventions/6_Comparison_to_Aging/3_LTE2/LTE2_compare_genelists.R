setwd('/Users/berenice/Desktop/LTE2/RNA-seq/Cohort6/GSEA')
...
# 2025-11-26
# Compare LTE2 and female aging

####################################################################################
# Load E2 responsive genes
e2.sig <- read.table('../DESeq2/2025-11-26_Peritoneal_Macrophage_Aging_LTE2c6_DESeq2_Old_E2_FDR5_genes_statistics.txt')
...
# E2_up   7 -0.4507783 -0.9920052 0.4769500 0.47506711 0.47506711
# E2_dwn 25  0.5244150  1.5869169 0.0279699 0.02958794 0.02958794

pdf(paste(Sys.Date(), "LTE2_responsive_GSEA_plot_Impact_F_aging.pdf", sep = "_"))
...
pdf(paste0(Sys.Date(),"F_Aging_GSEA_LTE2_GeneSets.pdf"),height = 4, width=5)
...
my.plot <- my.plot + scale_size_area(limits = c(0,2))
print(my.plot)
dev.off()
############################################################################################
