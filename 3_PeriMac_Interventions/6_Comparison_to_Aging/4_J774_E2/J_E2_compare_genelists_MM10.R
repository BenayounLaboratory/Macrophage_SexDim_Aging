# setwd('/Volumes/BB_HQ_1/Immune_sex_dimorphism_Aging/Macrophages/Clean_Macrophage_Data/RNAseq/Functional_enrichment/Sex_Hormone_Validation/J774A.1_E2/')
setwd('/Volumes/BB_Travel_2/J774_E2/GSEA/')
...
# 2025-09-01
# Compare E2 J774.1 and female aging

# 2025-11-24
# rerun using data aligned to the MM10 genome to match the rest of the study

####################################################################################
# Load E2 responsive genes
e2.sig <- read.table('/Volumes/BB_Travel_2/J774_E2/DESeq2/2025-11-24_J774A.1_E2_treatment_DESeq2_MM10_E2_FDR5_genes_statistics.txt')
...
# E2_up  14 0.3312302 0.8496072 6.501946e-01 6.581158e-01 6.581158e-01
# E2_dwn 18 0.8406461 2.3464206 8.270051e-13 2.762626e-07 5.525253e-07
...
pdf(paste0(Sys.Date(),"F_Aging_GSEA_E2sup_GeneSets_MM10.pdf"),height = 4, width=5)
