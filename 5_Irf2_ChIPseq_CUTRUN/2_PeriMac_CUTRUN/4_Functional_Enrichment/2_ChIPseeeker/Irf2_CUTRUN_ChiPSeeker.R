setwd('/Users/berenice/Desktop/Irf2_CUTRUN/ChIPSeeker/All_peaks')
...
# 2025-12-01
# run Irf2 CUTandRUN functional enrichment

######################################################################
### 1. read peak file
peak <- readPeakFile("../../MSPC/MSPC_Irf2_PeriMac_4samples_ConsensusPeaks.simple.bed")
peak

my.outprefix <- paste0(Sys.Date(),"_PeriMac_Irf2_CUTRUN_HOMER_CHIPSEEKER_analysis")
