setwd('/Users/berenice/Desktop/Irf2_CUTRUN/01_ChIPseq/ChIPSeeker')
...
# 2025-12-01
# run Irf2 ChIP-seq functional enrichment using new HOMER consensus peaks

######################################################################
### 1. read peak file
peak <- readPeakFile("../MSPC/MSPC_Irf2_BMDM_ConsensusPeaks.simple.bed")
peak

my.outprefix <- paste0(Sys.Date(),"_BMDM_Irf2_ChIPseq_HOMER_CHIPSEEKER_analysis")
